...
export namespace Prisma {
  ...
  */
  ...
  export type LogModelOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "message" | "origin" | "level" | "createAt", ExtArgs["result"]["logModel"]>
  ...
  interface LogModelFieldRefs {
    ...
    readonly createAt: FieldRef<"LogModel", 'DateTime'>
  }
  ...
  export type LogModelWhereInput = {
    ...
    createAt?: DateTimeFilter<"LogModel"> | Date | string
  }
  ...
  export type LogModelScalarWhereWithAggregatesInput = {
    ...
    createAt?: DateTimeWithAggregatesFilter<"LogModel"> | Date | string
  }
